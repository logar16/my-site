        ...
        >
          <Grid item>
            <Typography variant='body1'>
              ...
              I was able to achieve this within 400 episodes of training, viable to be on the official <Link color='secondary' href='https://github.com/openai/gym/wiki/Leaderboard#lunarlander-v2' target='_blank' rel="noreferrer">leaderboard</Link>.
              <br></br>
              <br></br>
              I built my own DQN agent from scratch, following the original DQN paper released by DeepMind.  

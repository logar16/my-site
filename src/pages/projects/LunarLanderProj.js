        ...
        <ul>
          ...
          <li>Gained practical PyTorch experience:
            <ul>
              ...
              <li>Formulated a Reinforcement Learning problem into a Supervised Learning problem to train the model</li>
          ...
          <li>Thoroughly graphed and output metrics to enable quick and efficient discernment of training progress and success or failure of evaluation</li>
  ...
  return (
    <div>
      ...
      <Typography variant='body1'>
        ...
        I made it very performant using PyTorch for both memory storage and the agent. I found PyTorch to be more performant than the Keras library I had initially attempted to use.
        With PyTorch, I was able to see a 50% or so increase in training speed as it took advantage of my multi-core CPU and my NVIDIA GPU much more easily.
        <br></br>
        <br></br>
